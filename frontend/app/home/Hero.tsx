...
export const Hero = () => {
  ...
  return (
    <header className="pt-24 px-4 max-w-[100vw] relative pb-12">
      ...
      <div className="top-0 left-0 -translate-x-1/2 -translate-y-1/2 -z-[15] absolute w-[300px] md:w-[800px] h-[300px] md:h-[800px] blur-[200px] rounded-full bg-opacity-30 bg-[#6741E8]"></div>
      <div className="bottom-0 right-0 translate-x-1/2 translate-y-1/2 -z-[15] absolute w-[300px] md:w-[800px] h-[300px] md:h-[800px] blur-[200px] rounded-full bg-opacity-30 bg-[#6741E8]"></div>
      <div className='container text-white mx-auto flex items-center w-full justify-between'>
        <div className="flex-1 text-center md:text-left mt-10 md:mt-0">
          <h2 className='text-sm font-medium md:font-semibold'>Explore ideas with Web3It.AI</h2>
          <TypewriterEffect words={words} className="font-semibold text-4xl md:text-5xl mt-4 min-h-20 md:min-h-12" />
          <h1 className='sr-only'>
            Fund your Web3 project with ease.
          </h1>
          <h2 className='text-sm md:text-base mt-4 md:mt-8 max-w-[700px]'>
