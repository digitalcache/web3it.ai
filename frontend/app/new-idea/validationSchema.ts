...
export const tokenSchema = Yup.object().shape({
  ...
  description: Yup.string().required('Please provide a description for your product').min(10, 'Please enter more than 10 characters').max(1000, 'Please enter less than 1000 characters'),
