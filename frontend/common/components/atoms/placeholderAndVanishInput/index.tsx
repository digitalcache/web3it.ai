  ...
  return (
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full bg-dark-background disabled:bg-zinc-600 transition duration-200 flex items-center justify-center"
      >
        <motion.svg
