        ...
        {data.map((item, index) => (
          ...
          >
            <div className="flex flex-col md:flex-row z-40 items-center top-40 self-start md:w-full lg:max-w-sm">
              <div className="h-8 absolute left-3 md:left-3 w-8 rounded-full bg-neutral-800 flex items-center justify-center">
                <div className="h-2 w-2 rounded-full bg-neutral-700 border border-neutral-500 p-1.5" />
              </div>
