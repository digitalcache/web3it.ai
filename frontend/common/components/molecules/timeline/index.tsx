        ...
        {data.map((item, index) => (
          ...
          >
            <div className="flex flex-col md:flex-row z-40 items-center top-40 self-start md:w-full lg:max-w-sm">
              <div className="h-8 absolute left-3 md:left-3 w-8 rounded-full bg-yankees-blue flex items-center justify-center">
            ...
            <div className="relative pl-16 pr-4 md:pl-4 w-full flex flex-col justify-center">
              <h3 className="md:hidden block text-xl mb-4 text-left font-bold text-neutral-300">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
