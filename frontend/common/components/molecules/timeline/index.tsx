  ...
  return (
    ...
    >
      <div className="mx-auto py-20">
        <h2 className="text-2xl mb-4 text-white font-medium max-w-4xl">
          This is how your journey would look like
        </h2>
        <p className="text-neutral-300 text-sm md:text-base">
          You can leverage AI to code out your ideas into a working app
        </p>
      </div>
