...
export const Token = ({
  ...
  return (
    ...
    >
      ...
      <div className={`transition duration-200 px-4 z-10 relative pb-3`}>
        ...
        <div className="flex justify-between flex-1 mt-2 items-center">
          <div className="flex text-neutral-200 justify-between w-full items-center">
            ...
            <div className="font-medium max-w-[80px] md:max-w-[130px] text-sm whitespace-nowrap text-ellipsis overflow-hidden">
              {card.creatorAddress}
            </div>
          </div>
        ...
        <div className="flex justify-between mt-2 items-center">
          {card.productUrl ? (
            <LinkStyled className="!px-0 !text-sm" href={card.productUrl} target="_blank">Explore</LinkStyled>
          ) : <div></div>}
